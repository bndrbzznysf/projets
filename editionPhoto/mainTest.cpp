...
int maitest() {
    ...
    //déclaration de vecteurs de niveaux de couleur pour créer une Image
    ...
    Image img = Image(rouge, vert, bleu);   //déclaration d'une image de test
    ...
    cout<<"Cas general : ";
    Image copie = Image(rouge, vert, bleu); //déclaration d'une copie de l'image de test
    ...
    cout<<"Cas general : ";
    copie = Image(rouge, vert, bleu);   //réinitialisation de la copie de l'image de test
    ...
    //valeurs de test pour luminosityUp et luminosityDown
